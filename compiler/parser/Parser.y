...
interface_body_decl
  ...
  | 'choice' tycon OF_TYPE btype_ maybe_docprev arecord_with_opt interface_choice_body
        { sL (comb3 $2 $6 $>) $ InterfaceChoice (InterfaceChoiceSignature Nothing $2 $4 $6 $5) (unLoc $7) }
  | consuming_ 'choice' tycon OF_TYPE btype_ maybe_docprev arecord_with_opt interface_choice_body
        { sL (comb3 $3 $7 $>) $ InterfaceChoice (InterfaceChoiceSignature (Just (unLoc $1)) $3 $5 $7 $6) (unLoc $8) }
  | var OF_TYPE sigtype maybe_docprev { sL1 $1 $ InterfaceFunctionSignature $1 $3 $4 }
